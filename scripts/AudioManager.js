...
export class AudioManager {
    constructor() {
        this.sounds = {};
        this.volume = 1.0; // Control de volumen de 0.0 a 1.0
    ...
    playSound(name, soundSpecificVolume = 1.0) {
        ...
        soundToPlay.volume = this.volume * soundSpecificVolume;
        // Rebobinamos el sonido al principio para poder reproducirlo de nuevo si ya estaba sonando.
